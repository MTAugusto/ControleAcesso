...
CREATE TABLE IF NOT EXISTS `controleacesso`.`clientes_veiculos` (
  `clientes` INT NOT NULL AUTO_INCREMENT,
  `veiculos` INT NOT NULL,
  PRIMARY KEY (`clientes`, `veiculos`),
  INDEX `fk_clientes_has_veiculos_veiculos1_idx` (`veiculos` ASC),
  INDEX `fk_clientes_has_veiculos_clientes1_idx` (`clientes` ASC),
...
-- -----------------------------------------------------
-- Table `controleacesso`.`movimentacao_veiculos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `controleacesso`.`movimentacao_veiculos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `veiculo` INT NOT NULL,
  `data` DATETIME NOT NULL,
  `entradaousaida` INT NOT NULL,
  PRIMARY KEY (`id`, `veiculo`),
  INDEX `fk_movimentacao_veiculos1_idx` (`veiculo` ASC),
  CONSTRAINT `fk_movimentacao_veiculos1`
    FOREIGN KEY (`veiculo`)
    REFERENCES `controleacesso`.`veiculos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `controleacesso`.`saida_veiculos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `controleacesso`.`saida_veiculos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `usuario` INT NOT NULL,
  `movimentacao_veiculos` INT NOT NULL,
  `valor` DECIMAL(10,2) NOT NULL,
  `iscortesia` TINYINT(1) NOT NULL,
  PRIMARY KEY (`id`, `usuario`, `movimentacao_veiculos`),
  INDEX `fk_saidas_usuarios1_idx` (`usuario` ASC),
  INDEX `fk_checkout_movimentacao1_idx` (`movimentacao_veiculos` ASC),
  CONSTRAINT `fk_saidas_usuarios1`
    FOREIGN KEY (`usuario`)
    REFERENCES `controleacesso`.`usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_checkout_movimentacao1`
    FOREIGN KEY (`movimentacao_veiculos`)
    REFERENCES `controleacesso`.`movimentacao_veiculos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `controleacesso`.`saidas_caixadiario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `controleacesso`.`saidas_caixadiario` (
  `saida_veiculos` INT NOT NULL,
  `caixadiario` INT NOT NULL,
  PRIMARY KEY (`saida_veiculos`, `caixadiario`),
  INDEX `fk_saida_veiculos_has_caixadiario_caixadiario1_idx` (`caixadiario` ASC),
  INDEX `fk_saida_veiculos_has_caixadiario_saida_veiculos1_idx` (`saida_veiculos` ASC),
  CONSTRAINT `fk_saida_veiculos_has_caixadiario_saida_veiculos1`
    FOREIGN KEY (`saida_veiculos`)
    REFERENCES `controleacesso`.`saida_veiculos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
